...
#define LORA_BASE_FREQUENCY_CUSTOM         (867LLU*MHZ)
#define LORA_BASE_FREQUENCY_VN         	   (920LLU*MHZ)

// Default settings
#define LORA_DEFAULT_TX_POWER              17
#define LORA_DEFAULT_SF                    7
#define LORA_DEFAULT_PREAMBLE_LEN          10
#define LORA_DEFAULT_RX_ADDR               0x00
#define LORA_DEFAULT_TX_ADDR               0x00
